...
import 'C:/Users/esarora/Desktop/my-expense-tracker/src/pages/Manager/NavbarMan.css';

function NavbarMan({ isRightSide = false }) { 
      ...
      <img src="https://logos-download.com/wp-content/uploads/2016/10/Deloitte_logo_black.png" alt="React Image" className="photo" />
        <div className={`collapse navbar-collapse ${menuClasses}`} id="navbarSupportedContent">
          ...
          <span>
            ...
            <li className="nav-button">
            <span>
            <Link className="nav-link" to="/expensechart">Expense Chart</Link>
            </span>
            </li>
            <li className="nav-button">
            <span>
